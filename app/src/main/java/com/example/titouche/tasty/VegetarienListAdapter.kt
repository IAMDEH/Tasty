...
class VegetarienListAdapter(private var myDataset: ArrayList<Vegetarien>, var mCtx: Context): RecyclerView.Adapter<VegetarienListAdapter.ViewHolder>(){
    class ViewHolder (holder : View): RecyclerView.ViewHolder(holder){
        val nom = holder.findViewById<TextView>(R.id.nomv)
        ...
        val dialogView = LayoutInflater.from(holder.getContext()).inflate(R.layout.order_vegetarien_dialog, null,false)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):ViewHolder{
        val view = LayoutInflater.from(parent.context).inflate(R.layout.vegetarien_list_item, parent, false)
