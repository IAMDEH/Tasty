...
class DiabetiqueListAdapter(private var myDataset: ArrayList<Diabetique>, var mCtx: Context): RecyclerView.Adapter<DiabetiqueListAdapter.ViewHolder>(){
    class ViewHolder (holder : View): RecyclerView.ViewHolder(holder){
        val nom = holder.findViewById<TextView>(R.id.nomdi)
        ...
        val dialogView = LayoutInflater.from(holder.getContext()).inflate(R.layout.order_diabetique_dialog, null,false)

    }

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):ViewHolder{
        val view = LayoutInflater.from(parent.context).inflate(R.layout.diabetique_list_item, parent, false)
